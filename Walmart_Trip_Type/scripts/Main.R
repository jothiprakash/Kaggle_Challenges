...
# Generates the features on Department and fineline through 
# Kmeans(Unsupervised Learning from trainData)
# Clustering Departments and fineline items based on their 
# class distributions in the train data.
